...
const integrations = [
    {
        ...
        description: "Lets you manage your child's schedule with ease, allowing for multiple check-ins (up to 2-3 times) within operating hours. Enjoy peace of mind knowing your child is always in good hands."
    },
    {
        image: "/images/attendance/recordcheckins.png",
        alt: "Record late check-ins",
        title: "Record late check-ins",
        description: "Easy to document tardy arrivals, keeping everything organized for both parents and staff."
    },
    {
    ...
    },
    {
        ...
        alt: "Go paperless",
        title: "Go paperless",
        description: "Easily switch to a paperless system with our childcare digital attendance solution and reduce your carbon footprint while increasing your savings."
    },
    {
        image: "/images/attendance/classroomratios.png",
        alt: "Easy to report",
        title: "Easy to report on",
        description: "Take an intuitive, rapid approach to sign-ins."
    },
...
const faqDataAttendance = [
    ...
    // Add more questions and answers specific to Page 1
];
        ...
        <div>
            <section className="relative bg-[#E9F0FF]">
                <div className="flex justify-center items-center sm:p-16 flex-col md:flex-row">
                    <div>
                        <h1 className="font-sans font-semibold text-5xl w-11/12 sm:w-9/12 text-[#42307D] tracking-tighter text-left p-8">Digital attendance for childcares and preschools – No more sign-in sheets</h1>
                ...
                <>
                    ...
                    <div className="flex flex-wrap mt-8">
                        {integrations.slice(3).map((integrate, index) => (
                            <div key={index} className="p-4 w-1/2 sm:w-1/2 hidden sm:block">
                                <img
                                    src={integrate.image}
                                    alt={integrate.alt}
                                    className="mx-auto"
            ...
            <section className="relative">
                <div className="px-4 sm:px-32 pb-10">
                    <div className="p-10">
                        ...
                        <p className="font-sans text-sm sm:text-base font-normal leading-30 tracking-normal text-left pt-5">Our childcare management software ensures that the daycare centers save money on cost and resources apart from the buying expenses. Our daycare management software solutions are offered at affordable cost and price to achieve the maximum possible value. The daycare management software system is uniquely Is customized to help run Arkaios daycares efficiently while offering high-quality care services to families and children.</p>
                    </div>
            ...
            <section className="relative">
                <div className="bg-gradient-to-b from-blue-200 to-white p-5">
                    ...
                    <div className="flex justify-center items-center">
                        <FAQ numberOfQuestions={4} useGridCols2={false} faqData={faqDataAttendance} />
                    </div>
                </div>
            </section>
            <section className="relative">
