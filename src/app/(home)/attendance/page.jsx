            ...
            <section className="relative">
                ...
                <div class="flex justify-center items-center p-6">
                    <div class="flex flex-col sm:flex-row gap-8">
                        <div class="card bg-[#7F56D9] text-white sm:w-[384px] w-[300px] h-[504px] p-6 grid grid-cols-1 gap-52">
                        ...
                        <div class="card bg-[#079455] text-white sm:w-[384px] w-[300px] h-[504px] p-6 grid grid-cols-1 gap-52">
                            <div class="flex items-center">
                        ...
                        <div class="card bg-[#1570EF] text-white sm:w-[384px] w-[300px] h-[504px] p-6 grid grid-cols-1 gap-52">
                            <div class="flex items-center">
