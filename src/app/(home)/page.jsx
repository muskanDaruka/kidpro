            ...
            <div className="sm:w-full w-screen">
                <section className="relative w-full">
                    <div className="bg-[url('/images/banner-bg.png')] bg-no-repeat bg-cover h-[881px]">
                                ...
                                <div className="bg-none md:bg-[url('/images/planet2.png')] md:bg-no-repeat md:bg-right">
                                    <div className="bg-[url('/images/planet3.png')] bg-no-repeat bg-bottom left-32 top-[80px] text-white md:relative text-center md:text-left right-[72px]">
                                        <div className="bg-[url('/images/bg.png')] bg-cover bg-repeat p-6 rounded-md max-w-[900px]">
                                            <p className="font-baloo-chettan-2 text-xl mb-2 mt-10">Best Childcare Management Software</p>
                                            <h1 className="font-bold text-4xl mb-2 font-baloo-chettan-2">Fueling Daycare Centers</h1>
                                            <p className="font-normal text-xl mb-4 font-baloo-chettan-2">Empower your daycare center with cutting-edge childcare management software, streamlining operations and enhancing child care quality for a seamless and efficient experience.</p>
                                            <button className="w-[202px] h-[52px] bg-white rounded-full text-[#00008B] text-xl font-baloo-chettan-2">Request Demo</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <Image
                            ...
                            alt="home"
                            className="absolute w-full object-cover opacity-50 top-[835px] md:top-[420px]"
                            width={2109} height={183.95}
                        />
                        <div className="bg-[url('/images/cloud-design-1.png')] md:h-[550px] w-full md:w-full md:relative relative bg-cover bg-center -top-36 md:-top-16 flex flex-col justify-center items-center md:pb-[100px]">
                            <h1 className="text-xl sm:text-4xl text-black font-bold font-baloo-chettan-2 text-center mb-5 mt-32 sm:mt-0">Why choose Kidpro Chidcare Management software</h1>
                            <p className="text-[#426666] font-normal text-center mb-32 font-baloo-chettan-2 sm:mb-12">Embrace efficiency, simplify management, and nurture growth with our childcare management software.</p>
                        </div>
                    </div>
                </section>
                        ...
                        {data.map((item, index) => (
                            <div key={index} className={`m-2 p-4 bg-white shadow-2xl rounded-lg sm:w-[597.67px] w-[80%] sm:ml-0 ml-10 ${index > 0 ? 'hidden sm:block' : ''}`}>
                                <div className="flex flex-col sm:flex-row items-center">
                                    <Image src={item.image} alt="home" className="text-center p-2 max-w-[50px] max-h-[50px] sm:max-w-full sm:max-h-full mb-4 sm:mb-0" width={50} height={50} />

                                    <div className="ml-4">
                                        <h1 className="text-lg font-semibold font-baloo-chettan-2">{item.title}</h1>
                                        <p className="text-sm font-baloo-chettan-2">{item.description}</p>
                                    </div>
                                </div>
                            </div>
                        ))}
                        ...
                        <div className="sm:flex-1 m-2 p-4 h-[130px] text-center sm:text-left">
                            <div className="sm:flex items-center">
                                <div className="ml-0 sm:ml-[220px]">
                                    <p className="text-gray-500 p-4 sm:pl-0 ml-0 sm:ml-[50px] font-baloo-chettan-2">Lorem Ipsum</p>
                                    <h1 className="font-bold ml-0 sm:ml-[50px] text-2xl font-baloo-chettan-2">Your complete preschool & <br className="hidden sm:block" />childcare software system.</h1>
                                </div>
                            </div>
                        </div>
                        <div className="flex-1 m-2 p-4 h-[130px]">
                            <div className="flex items-center">
                                <div className="ml-[30px]">
                                    <p className="text-gray-500 p-4 leading-6 sm:text-xl font-baloo-chettan-2">Stay compliant with digital check-in,<br /> health checks,
                                        and room ratio tracking<br /> and run reports quickly</p>
                                    {/* <button className="flex w-[190px] h-[40px] bg-[#1747C8] rounded-full text-white text-xl ml-[50px] sm:ml-2 pl-5 p-2">Read more
                        ...
                        {softwareImages.map((item, index) => (
                            ...
                            >
                                ...
                                <div className="absolute top-0 left-0 right-0 bottom-0 flex flex-col justify-center p-5 text-white">
                                    <h1 className="font-bold text-xl text-black z-10 md:top-[50%] mt-6 font-baloo-chettan-2">{item.title}</h1>
                                    <p className="font-normal text-xl text-black opacity-30 z-10 font-baloo-chettan-2">{item.description}</p>
                                </div>
                            </div>
                        ))}
                    </div>
                    <div className=" flex-1 flex items-center justify-center mt-10">
                        <button className="flex w-[190px] h-[50px] bg-[#1747C8] rounded-full text-white text-xl sm:ml-2 pl-5 p-3 font-baloo-chettan-2">Read more
                ...
                <section className="bg-white flex flex-col sm:flex-row p-10 gap-10">
                    <div className="flex-1 flex flex-col justify-center space-y-5">
                        <p className="font-normal text-gray-500 opacity-50 mt-8 md:mt-0 font-baloo-chettan-2">Center Management</p>
                        <h2 className="text-3xl sm:text-4xl font-bold font-baloo-chettan-2">
                            Unlock Seamless Childcare Management with KidsPro: Watch Our Demo!
                        </h2>
                        <h5 className="w-full">
                            <p className="text-left text-lg font-normal leading-9 max-sm:text-justify font-baloo-chettan-2">
                        ...
                        <button className=" flex w-[200px] h-[52px] bg-[#1747C8] rounded-full text-white text-xl p-3 font-baloo-chettan-2">Watch Demo
                            <Image src="/images/arrow-right.png" alt="home" className="text-center p-2 ml-5" width={32} height={32} />
                        </button>
                    </div>
                    <div className="flex-1">
                ...
                <section className="relative bg-white p-5">
                    <p className="font-bold text-gray-500 opacity-50 text-center font-baloo-chettan-2">Lorem Ipsum</p>
                    <p className="font-bold text-center text-3xl font-baloo-chettan-2">Who uses our <br className="hidden sm:block" />Childcare Management Software?</p>
                    <p className="font-normal text-gray-500 opacity-50 text-center font-baloo-chettan-2 mb-8">Discover why childcare centers, preschools, and early learning professionals rely on our software to elevate their operations and enhance the childcare experience.</p>
                        ...
                        <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4 ">
                            {categories.map((category, index) => (
                                <div key={index} className={`w-[370px] h-[400px] shadow sm:flex-shrink-0  ${index > 0 ? 'hidden sm:block' : ''}`}>
                                    ...
                                    <h1 className="font-bold font-baloo-chettan-2">{category.title}</h1>
                                    <p className="font-normal font-baloo-chettan-2">{category.description}</p>
                                    <a className="text-[#1747C8] mt-2 md:mt-4 font-baloo-chettan-2">Read more</a>
                                </div>
                            ))}
                        </div>
                    </div>
                        ...
                        <div className="hidden sm:block">
                            <div className="pt-44 pl-56 pb-10 ml-[10px] p-4 sm:p-8 md:p-12 lg:p-16">
                                <div className="flex">
                                    ...
                                    />
                                    <div>
                                        <h1 className="font-bold text-4xl text-center mb-10 font-baloo-chettan-2">Happy Clients</h1>
                                        <p className="font-normal text-center text-2xl text-[#4C4C4C] ml-[50px] font-baloo-chettan-2">Thriving with KidsPro: Our Happy Clients Speak! Join the league of satisfied preschools revolutionizing childcare management. Discover joy in efficiency, simplicity, and excellence with KidsPro.</p>
                                    </div>
                                </div>
                            </div>
                            <div className="flex">
                                <div className="m-10">
                                    ...
                                    <div className="flex">
                                        ...
                                        <p className="font-normal text-xl text-[#4C4C4C] pb-2 font-baloo-chettan-2">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore <br className="hidden sm:block" />eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non<br className="hidden sm:block" /> proident.Duis aute irure dolor in reprehenderit in voluptate velit esse<br className="hidden sm:block" /> cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat<br className="hidden sm:block" /> non proident.</p>
                                        <div className="mt-16 pl-8">
                                            <button className="w-7 h-7 border-black border-radius-2 bg-white">&gt;</button>
                                        </div>
                                    </div>
                                    <h1 className="font-bold pb-2 ml-16 font-baloo-chettan-2">Rowhan Smith</h1>
                                    <div className="flex">
                                        <p className="text-[#4C4C4C] ml-16 font-baloo-chettan-2">Parent</p>
                                    </div>
                                </div>
                                <Image
                            ...
                            <div className="p-4 sm:p-8 md:p-12 lg:p-16">
                                <div className="flex flex-col sm:flex-row">
                                    ...
                                    <div className="mt-4 sm:mt-0 sm:ml-4 md:ml-8 lg:ml-12">
                                        <h1 className="font-bold text-2xl sm:text-4xl text-center sm:text-left mb-4 font-baloo-chettan-2">Happy Clients</h1>
                                        <p className="font-normal text-center sm:text-left text-lg sm:text-2xl text-[#4C4C4C] font-baloo-chettan-2">
                                ...
                                <div className="flex">
                                    ...
                                    <p className="font-normal text-sm sm:text-lg text-[#4C4C4C] pb-2 font-baloo-chettan-2">
                                ...
                                <div className="mt-4 sm:mt-0 sm:ml-8 flex ">
                                    ...
                                    />
                                    <div>
                                        <h1 className="font-bold text-lg sm:text-xl pb-1 font-baloo-chettan-2">Rowhan Smith</h1>
                                        <p className="text-[#4C4C4C] text-sm sm:text-base font-baloo-chettan-2">Parent</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <section className="relative ">
                    <div className="flex justify-between p-16 bg-white">
                        <div className="hidden sm:block">
                            <h1 className="font-bold text-2xl ml-[100px] font-baloo-chettan-2">Featured Post</h1>
                            <Image
                                src="/images/childrens.jpeg" alt="image"
                                className="w-[669px] h-[352px] mr-4 ml-[100px]"
                                width={669}
                                height={352}
                            />
                            <h1 className="font-normal text-base sm:text-xl ml-[100px] mt-8 font-baloo-chettan-2">By John Doe May 23, 2022 </h1>
                            <p className="font-bold mt-2 line-clamp-3 text-sm sm:text-base ml-[100px] mt-5 font-baloo-chettan-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor.</p>
                            <p className="font-normal text-base text-normal ml-[100px] mt-2 font-baloo-chettan-2">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore <br className="hidden sm:block" />eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non<br className="hidden sm:block" /> proident.Duis aute irure dolor in reprehenderit in voluptate velit esse<br className="hidden sm:block" /> cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat<br className="hidden sm:block" /> non proident.</p>
                            <div className="ml-[96px] m-5">
                                <button className="flex w-[190px] h-[40px] bg-[#1747C8] rounded-full text-white text-xl sm:ml-2 pl-5 p-2 font-baloo-chettan-2">Read more
                                    <Image src="/images/arrow-right.png" alt="home" className="text-center p-2 ml-5" width={32} height={32} />
                                </button>
                            </div>
                        </div>
                        <div>
                            <div className="flex">
                                <h1 className="font-bold text-xl sm:text-2xl font-baloo-chettan-2">All Post</h1>
                                <Link href="/" className="text-[#1747C8] text-base ml-[100px] sm:ml-[320px] underline font-baloo-chettan-2">
                                    View more
                                </Link>
                            </div>
                            {allPost.map((item, index) => (
                                <div key={index} className="mt-5 w-full sm:w-[500px] h-[150px]">
                                    <h1 className="font-normal text-base sm:text-xl font-baloo-chettan-2">By {item.title} {item.date}</h1>
                                    <p className="font-bold mt-2 line-clamp-3 text-sm sm:text-base sm:line-clamp-none font-baloo-chettan-2">{item.description}</p>
                                </div>
                            ))}
                        </div>
                    </div>
                ...
                <section className="relative">
                    <div className="bg-gradient-to-b from-blue-200 to-white w-full md:w-full h-full md:h-[873px] p-8 md:p-32 ">
                        <div className="md:flex md:justify-center gap-64">
                            <div className="md:mr-2 ">
                                <p className="font-normal opacity-50 font-baloo-chettan-2">FREQUENTLY ASKED QUESTIONS</p>
                                <h1 className="font-bold text-4xl mt-2 font-baloo-chettan-2">Frequently Asked Questions</h1>
                            </div>
                            <div className="md:w-[500px] mt-4 md:mt-0">
                                <p className="font-normal text-base text-normal text-xl opacity-50 ml-0 md:[ml-100px] md:mt-0 font-baloo-chettan-2">
                ...
                <section className="relative flex flex-col items-center justify-center w-full h-[700px] bg-white p-4">
                    <p className="text-center font-bold opacity-50 text-lg sm:text-xl font-baloo-chettan-2">Lorem ipsum</p>
                    <h1 className="font-bold text-center text-2xl sm:text-5xl mt-3 sm:mt-5 font-baloo-chettan-2">Ready to get started?</h1>
                    <p className="opacity-30 text-center font-bold mt-3 sm:mt-5 text-sm sm:text-base font-baloo-chettan-2">Ready to transform your childcare experience? Get started with KidsPro today. Streamline operations,<br /> enhance communication, and create a nurturing environment for young minds to thrive!</p>
                    <p className="font-bold text-center mt-4 sm:mt-5 text-sm sm:text-base font-baloo-chettan-2">Rated 4.9/5 from over 600 reviews.</p>
                    <Image
                    ...
                    <div className="flex items-center mt-3 sm:mt-6">
                        ...
                        <span className="mx-2 font-baloo-chettan-2">Or</span>
                        <hr className="w-16 sm:w-32" />
                    </div>
                    <div className="mt-5 sm:mt-10">
                        <button className="flex w-full max-w-[220px] h-[50px] bg-[#1747C8] rounded-full text-white text-xl sm:ml-2 pl-3 sm:pl-5 p-2 font-baloo-chettan-2">
                            Request Demo
